...
The automated suite has 21 tests covering the decision tree, confidence formula, time normalization, hedge terms, entity overlap, polarity, quote verification, embedding-cache reuse, and the direct/inferential/false-positive MiniLM fixtures.
