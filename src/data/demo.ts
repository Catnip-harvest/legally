export const DEMO_LABEL_A = "March 14, 2023 deposition";
export const DEMO_LABEL_B = "September 9, 2023 deposition";

export const DEMO_TRANSCRIPT_A = `Deposition of Marcus Webb — March 14, 2023
...
export const DEMO_TRANSCRIPT_B = `Deposition of Marcus Webb — September 9, 2023
